...
public class CreateAccountController implements Initializable {
    ...
    ObservableList<String> list2 = FXCollections.observableArrayList("Christianity","Hinduism","Islam","Other");
    ...
    public boolean validateName(){
        ...
        if(m.find() && m.group().equals(name.getText())){
            return true;
                ...
                a.setContentText("Please enter only characters in name \nPLEASE TRY AGAIN !");
                a.showAndWait();
                return false;  
        }
    }
    ...
    public boolean validateMobileNo(){
        ...
        if(m.find() && m.group().equals(mobileno.getText())){
            return true;
                ...
                a.setHeaderText("Error In Mobile Number");
                a.setContentText("Please enter only numbers in Mobile Number \nPLEASE TRY AGAIN !");
                a.showAndWait();
                return false;  
        }
    }
    ...
    public boolean validateIdCardNo(){
        ...
        if(m.find() && m.group().equals(idcardno.getText())){
            return true;
                ...
                a.setHeaderText("Error In ID Card Number");
                a.setContentText("Please enter only numbers in ID Card Number \nPLEASE TRY AGAIN !");
                a.showAndWait();
                return false;  
        }
    }
    ...
    public boolean validateBalance(){
        ...
        if(m.find() && m.group().equals(balance.getText())){
            return true;
                ...
                a.setHeaderText("Invalid Balance");
                a.setContentText("Please enter only positive numbers in Balance \nPLEASE TRY AGAIN !");
                a.showAndWait();
                return false;  
        }
    }
    ...
    public void newAccount(MouseEvent event){
        ...
        try{
            ...
            else
            {
                ...
                a.setContentText("Your account could not be created \nPLEASE TRY AGAIN !");
                a.showAndWait();
            }
           } 
